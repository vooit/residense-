    ...
    _this.init = function(force, forceCalcSlides) {
        ...
        if (params.slidesPerView==='auto') {
            ...
            for (var i=0; i<_this.slides.length; i++) {
                ...
                if(wrapper.classList.contains('slider')){
                    for (var l=0; l<_this.slides[i].getElementsByTagName('img').length; l++) {
                            _this.slides[i].getElementsByTagName('img')[l].style.width = slideWidth+'px'
                    }
                }
            }
